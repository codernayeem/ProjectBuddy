...
const navigation = [
  ...
  { name: 'Jobs', href: '/dashboard/jobs', icon: BookOpen },
];
                ...
                <li key={item.name}>
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ? 'bg-linkedin-50 text-linkedin-700 dark:bg-linkedin-900/20 dark:text-linkedin-400'
                        : 'text-gray-700 hover:text-linkedin-600 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-700'
                    )}
                  >
                    <item.icon className={cn(
                      'h-5 w-5 shrink-0',
                      isActive ? 'text-linkedin-600 dark:text-linkedin-400' : 'text-gray-400'
                    )} />
                    {item.name}
                  </Link>
                </li>

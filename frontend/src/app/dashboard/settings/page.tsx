...
const profileSchema = z.object({
  ...
  preferredRole: z.nativeEnum(PreferredRole),
  experienceLevel: z.nativeEnum(ExperienceLevel),
  skills: z.string().optional(),
  interests: z.string().optional(),
  languages: z.string().optional(),
  timezone: z.string().optional(),
  isAvailableForProjects: z.boolean()
})
...
export default function SettingsPage() {
  ...
  const profileForm = useForm<ProfileFormData>({
    ...
    defaultValues: {
      ...
      preferredRole: user?.preferredRole || PreferredRole.OTHER,
      experienceLevel: user?.experienceLevel || ExperienceLevel.BEGINNER,
      skills: user?.skills?.join(', ') || '',
      interests: user?.interests?.join(', ') || '',
      languages: user?.languages?.join(', ') || '',
      timezone: user?.timezone || '',
      isAvailableForProjects: user?.isAvailableForProjects ?? true
    }
  })
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <Select value={profileForm.watch('preferredRole')} onValueChange={(value: string) => profileForm.setValue('preferredRole', value as PreferredRole)}>
                        <SelectTrigger className="mt-1">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div>
                      ...
                      <Select value={profileForm.watch('experienceLevel')} onValueChange={(value: string) => profileForm.setValue('experienceLevel', value as ExperienceLevel)}>
                        <SelectTrigger className="mt-1">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      id="isAvailableForProjects"
                      checked={profileForm.watch('isAvailableForProjects')}
                      onCheckedChange={(checked: boolean) => profileForm.setValue('isAvailableForProjects', checked)}
                    />
                    <Label htmlFor="isAvailableForProjects">

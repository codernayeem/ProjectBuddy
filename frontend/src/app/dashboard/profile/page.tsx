              ...
              <div className="flex-1 space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  {profileData.isVerified && (
                    <UIBadge variant="secondary" className="text-blue-600">
            ...
            <Card className="lg:col-span-2">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700">Preferred Role</label>
                    <p className="text-gray-900 mt-1">{formatEnumValue(profileData.preferredRole)}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-700">Experience Level</label>
                    <p className="text-gray-900 mt-1">{formatEnumValue(profileData.experienceLevel)}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-700">Available for Projects</label>
                    <p className="text-gray-900 mt-1">
                      {profileData.isAvailableForProjects ? '✅ Yes' : '❌ No'}
                    </p>
                  </div>
                  {profileData.company && (
                    <div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {profileData.languages.map((language: string) => (
                      <UIBadge key={language} variant="outline">
                        {language}
                      </UIBadge>
                    ))}
                  </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 mt-1">{profileData.profileViews || 0}</p>
                  </div>
                </div>
              </div>
            </CardContent>
